...
public class RestaurantTest {
	...
	@Test
	public void testStringToJSONArray() throws JSONException {
		String s = "Chinese,Japanese";
		JSONAssert.assertEquals(new JSONArray("[Chinese,Japanese]"), Restaurant.stringToJSONArray(s),
				JSONCompareMode.NON_EXTENSIBLE);
	}

	@Test
	public void testStringToJSONArrayCornerCases() throws JSONException {
		String s = "";
		JSONAssert.assertEquals(new JSONArray("[]"), Restaurant.stringToJSONArray(s), JSONCompareMode.NON_EXTENSIBLE);
		s = "Chinese";
		JSONAssert.assertEquals(new JSONArray("[Chinese]"), Restaurant.stringToJSONArray(s),
				JSONCompareMode.NON_EXTENSIBLE);
		s = "Chinese,";
		JSONAssert.assertEquals(new JSONArray("[Chinese,]"), Restaurant.stringToJSONArray(s),
				JSONCompareMode.NON_EXTENSIBLE);
